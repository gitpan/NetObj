# This Makefile is for the NetObj extension to perl.
#
...
# These definitions are from config.sh (via /usr/lib/perl5/i586-linux/5.003/Config.pm)
...
INSTALLARCHLIB = $(PREFIX)/lib/perl5/i586-linux/5.003
...
PERL_ARCHLIB = /usr/lib/perl5/i586-linux/5.003
...
PERLMAINCC = $(CC)
PERL_INC = /usr/lib/perl5/i586-linux/5.003/CORE
PERL = /usr/bin/perl
...
PM_TO_BLIB = servertest.pl \
	$(INST_LIBDIR)/servertest.pl \
	NetObj/Config.pm \
	$(INST_LIBDIR)/NetObj/Config.pm \
	NetObj/Server.pm \
	$(INST_LIBDIR)/NetObj/Server.pm \
	NetObj/Request.pm \
	$(INST_LIBDIR)/NetObj/Request.pm \
	NetObj.pm \
	$(INST_LIBDIR)/NetObj.pm \
	NetObj/Block.pm \
	$(INST_LIBDIR)/NetObj/Block.pm
...
$(INST_AUTODIR)/.exists :: /usr/lib/perl5/i586-linux/5.003/CORE/perl.h
	@$(MKPATH) $(INST_AUTODIR)
	@$(EQUALIZE_TIMESTAMP) /usr/lib/perl5/i586-linux/5.003/CORE/perl.h $(INST_AUTODIR)/.exists

	-@$(CHMOD) 755 $(INST_AUTODIR)

$(INST_LIBDIR)/.exists :: /usr/lib/perl5/i586-linux/5.003/CORE/perl.h
	@$(MKPATH) $(INST_LIBDIR)
	@$(EQUALIZE_TIMESTAMP) /usr/lib/perl5/i586-linux/5.003/CORE/perl.h $(INST_LIBDIR)/.exists

	-@$(CHMOD) 755 $(INST_LIBDIR)

$(INST_ARCHAUTODIR)/.exists :: /usr/lib/perl5/i586-linux/5.003/CORE/perl.h
	@$(MKPATH) $(INST_ARCHAUTODIR)
	@$(EQUALIZE_TIMESTAMP) /usr/lib/perl5/i586-linux/5.003/CORE/perl.h $(INST_ARCHAUTODIR)/.exists
...
realclean purge ::  clean
	...
	rm -f $(INST_LIBDIR)/servertest.pl $(INST_LIBDIR)/NetObj/Config.pm $(INST_LIBDIR)/NetObj/Server.pm $(INST_LIBDIR)/NetObj/Request.pm $(INST_LIBDIR)/NetObj.pm $(INST_LIBDIR)/NetObj/Block.pm
